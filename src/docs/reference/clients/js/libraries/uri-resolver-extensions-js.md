...
This package is open-source. It lives within the [Polywrap toolchain repo](https://github.com/polywrap/toolchain/tree/origin-0.10/packages/js/uri-resolver-extensions). Contributions from the community are welcomed!
