...
We'll import our first dependency using a Wrap URI with the `http` authority. The URI points to Polywrap's own Wrapscan registry, which is still in construction as of the time of this writing.
...
#import { Module } into Sha3 from "http/https://wraps.wrapscan.io/r/polywrap/sha3@1.0.0"
