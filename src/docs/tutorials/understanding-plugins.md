...
The Polywrap client has a [default configuration](https://github.com/polywrap/toolchain/blob/origin-dev/packages/js/client-config-builder/src/bundles/default.ts) that enables developers to use the following plugins and the interfaces they implement:  
